...
| **CDEFLevel**                      | --enable-cdef          | [-1-17]          | -1            | Enable Constrained Directional Enhancement Filter (0: Disable CDEF, -1: Dynamically select CDEF level based on settings such as `--preset`, 1: Full CDEF, 2-17: Higher CDEF level trades CDEF quality for speed)                                                                                                                      |
