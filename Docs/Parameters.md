...
| **PsyBiasOptimizeB**             | --psy-bias-optimize-b       | [0-3]                          | 0           | Optimize quantization using full distortion calculation. Slow. [0: Disabled, 1: Use slow method to optimize eob, and then use normal optimization, 2: Use slow method to optimize eob and lower coefficients, 3: Use slow method to optimize eob and adjust coefficients both ways] |
