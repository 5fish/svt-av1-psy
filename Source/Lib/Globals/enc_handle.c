...
static void copy_api_from_app(
    ...
    scs->static_config.noise_strength = ((EbSvtAv1EncConfiguration*)config_struct)->noise_strength;
    scs->static_config.noise_strength_chroma = ((EbSvtAv1EncConfiguration*)config_struct)->noise_strength_chroma;
    scs->static_config.noise_size = ((EbSvtAv1EncConfiguration*)config_struct)->noise_size;
